  ...
  @Output() someEvent = new EventEmitter();
    ...
    toggleView(detailobj:any) {
      ...
      if(detailobj){
        ...
        //   let el = document.getElementById('windowMode');
        //   //el.scrollIntoView(true);
        //  //el.innerHTML.add 
         
        //  //document.getElementById('bodybox').scrollTop -= 500;
        //   //.scrollable-container
        //   //document.getElementsByClassName('scrollable-container').scrollIntoView(true)
        //   //window.scrollBy(0, -10)
        //   // let el=document.getElementById('bodybox')
        //   // el.scroll(0,0);
        //   //document.getElementsByClassName('layout-container').
        //   //window.scrollTo(0, 0)
        // }
...
this.router.navigate(['pages/e-commerce/DonationForm'], { state: { data: datatobj } });
